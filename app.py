# import heapq
# from flask import Flask, make_response, redirect, render_template, request, send_file, send_from_directory
# import numpy as np
...
# #downloading the summarized content
# app = Flask(__name__)
...
# #downloading the entire transcript
# # app = Flask(__name__)
...
# #     pdf = pdfkit.from_string(trans, False)
# #     response = make_response(pdf)
# #     response.headers['Content-Type'] = 'application/pdf'
